      ...
      <div className="py-8 px-12">
        ...
        <div className="grid grid-cols-3">
          <div className="flex flex-col m-12">
            ...
            <div className="">
              <h4 className="text-[#2496ed] tracking-wider text-xl font-medium mb-4">I want to:</h4>
          ...
          {state.usage.length > 0 && (
            ...
            <div className="bg-[#20252d] rounded-lg border-l-8 border-solid border-l-[#2496ed] flex flex-row justify-between">
