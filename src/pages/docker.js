...
export default function Docker() {
  ...
  const onFirstChange = (selectedOption) => {
    ...
    } else if (dockerOptionsSecond[selectedOption.value].length === 1) {
      setState((prevState) => ({ ...prevState, firstOption: selectedOption, showSecond: true }));
      onSecondChange(dockerOptionsSecond[selectedOption.value][0]);
    } else {
      setState((prevState) => ({ ...prevState, firstOption: selectedOption, showSecond: true }));
    }
  };
    ...
    <div className="py-8 px-12">
      ...
      <div className="grid grid-cols-3">
        <div className="flex flex-col m-12">
          ...
          <div className="">
            <h4 className="text-docker tracking-wider text-xl font-medium mb-4">I want to:</h4>
        ...
        {state.usage.length > 0 && (
          ...
          <div className="bg-primary rounded-lg border-l-8 border-solid border-l-docker flex flex-row justify-between">
