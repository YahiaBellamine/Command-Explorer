...
export default function Home() {
  ...
  return (
    ...
    <Head>
        ...
        <meta name="description" content="Prévenir" />
        ...
        <div className="grid grid-cols-3">
          <div className="flex flex-col m-12">
            <h2 className="text-[#20252d] text-3xl font-bold tracking-wider mb-6">
              Git <span className='text-[#00bfaa]'>Command</span> Explorer
            </h2>

            <div className="">
              <h4 className="text-[#00bfaa] tracking-wider text-xl font-medium mb-4">I want to:</h4>
          ...
          {state.usage.length ? (
            ...
            <div className="bg-[#20252d] rounded-2xl border-l-8 border-solid border-l-[#00bfaa] flex flex-row justify-between">
